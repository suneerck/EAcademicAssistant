                ...
                try {
                    ...
                    when (response.code()) {
                        OkHttpUtils.STATUS_OK -> {
                            runOnUiThread {
                                Toast.makeText(this@CreateTeacherActivity, "Registration Successfully Completed", Toast.LENGTH_SHORT).show()
                                SnackBarUtils.showSnackBar(this@CreateTeacherActivity, "Register success")
                                finish()
                            }
                        }
                        OkHttpUtils.STATUS_ERROR -> {
                            ...
                            runOnUiThread {
                                ...
                                btnSubmit.isEnabled = true
                                pbLoading.visibility = View.GONE
                                SnackBarUtils.showSnackBar(this@CreateTeacherActivity, message)
