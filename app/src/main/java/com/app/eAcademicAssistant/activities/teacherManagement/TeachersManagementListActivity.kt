...
import com.app.eAcademicAssistant.adapters.TeachersManagementRvAdapter
...
class TeachersManagementListActivity : AppCompatActivity() {
    ...
    private var menuList = ArrayList<StudentsMenuModel>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_teachers_management_list)

        init()

        fabAdd.setOnClickListener{
            val intent = Intent(this, CreateTeacherActivity::class.java)
    ...
    private fun getTeachersList() {
        ...
        val gander = JSONArray()
        val jsonUserTypes = JSONArray()
        jsonUserTypes.put(MenuConstants.TEACHER)
        jsonObject.put(
            "userId",
            DatabaseUtils.getInstance(this@TeachersManagementListActivity).getUser()?.userId
        )
                ...
                if (e is UnknownHostException) {
                    runOnUiThread {
                        SnackBarUtils.showSnackBar(
                            this@TeachersManagementListActivity,
                ...
                try {
                    ...
                    when (response.code()) {
                        OkHttpUtils.STATUS_OK -> {
                            ...
                            runOnUiThread {
                                ...
                                rvStudentsManagement.layoutManager =
                                    LinearLayoutManager(this@TeachersManagementListActivity)
                                rvStudentsManagement.adapter = TeachersManagementRvAdapter(
                                    this@TeachersManagementListActivity,
                                    menuList
                                )
                        ...
                        OkHttpUtils.STATUS_ERROR -> {
                            ...
                            runOnUiThread {
                                pbLoading.visibility = View.GONE
                                SnackBarUtils.showSnackBar(this@TeachersManagementListActivity, message)
