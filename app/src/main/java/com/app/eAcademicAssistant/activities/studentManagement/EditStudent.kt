                ...
                try {
                    ...
                    when (response.code()) {
                        OkHttpUtils.STATUS_OK -> {
                            runOnUiThread {
                                SnackBarUtils.showSnackBar(this@EditStudent, "Registration success")
                                finish()
                            }
                        }
                        OkHttpUtils.STATUS_ERROR -> {
                            val message = jo.getString("message")
                            Toast.makeText(this@EditStudent, "An error occurred ..!!", Toast.LENGTH_SHORT).show()
                            ...
                            runOnUiThread {
                                ...
                                btnSubmit.isEnabled = true
                                pbLoading.visibility = View.GONE
                                SnackBarUtils.showSnackBar(this@EditStudent, message)
