...
class CreateHodActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSubmit.setOnClickListener {
            ...
            registerHod(username, password, email, gender)
    ...
    private fun registerHod(userName: String, password: String, email: String, gender: Int) {
        ...
        Log.e("_____________req", "registerHod : $jsonObject")
        ...
        doLogin?.enqueue(object : Callback {
            override fun onFailure(call: Call?, e: IOException?) {
                Log.e("___________onFailure", "registerHod")
                if (e is UnknownHostException) {
                    runOnUiThread {
                        SnackBarUtils.showSnackBar(
                            this@CreateHodActivity,
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                Log.e("______________resp", "registerHod:$resp")
                try {
                    ...
                    when (response.code()) {
                        ...
                        OkHttpUtils.STATUS_ERROR -> {
                            ...
                            Log.e("_______resp_error", "registerHod:$message")
                            runOnUiThread {
                                btnSubmit.text = "Login"
                                btnSubmit.isEnabled = true
                                pbLoading.visibility = View.GONE
                                SnackBarUtils.showSnackBar(this@CreateHodActivity, message)
                            ...
                            Log.e("_______Internal_error", "registerHod")
                            runOnUiThread {
                                SnackBarUtils.showSnackBar(
                                    this@CreateHodActivity,
                    ...
                    Log.e("__________exc", "registerHod" + e.message)
                    runOnUiThread {
                        SnackBarUtils.showSnackBar(
                            this@CreateHodActivity,
                            getString(R.string.error_message_server_error)
