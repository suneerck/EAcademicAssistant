...
class CourseListTimeTableRvAdapter(
    var context: TimeTableManagementActivity,
    ...
    RecyclerView.Adapter<CourseListTimeTableRvAdapter.ViewHolder>() {

    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): CourseListTimeTableRvAdapter.ViewHolder {
