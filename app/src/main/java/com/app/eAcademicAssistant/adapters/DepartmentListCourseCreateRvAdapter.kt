...
import com.app.eAcademicAssistant.activities.coursesManagement.courses.CreateCourseActivity
import com.app.eAcademicAssistant.model.DepartmentMenuModel
import com.google.android.material.floatingactionbutton.FloatingActionButton

class DepartmentListCourseCreateRvAdapter(
    var context: CreateCourseActivity,
    var list: ArrayList<DepartmentMenuModel>,
    var tvSelectDepartmentInCharge: TextView,
    var dialog: Dialog
) :

    RecyclerView.Adapter<DepartmentListCourseCreateRvAdapter.ViewHolder>() {

    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): DepartmentListCourseCreateRvAdapter.ViewHolder {
