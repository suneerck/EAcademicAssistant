...
class CalendarCreateMonthRvAdapter(
    private val year: Int,
    private val month: Int,
    private val activity: CalendarCreateActivity,
    private val adapter: CalendarCreateRvAdapter
) :
    RecyclerView.Adapter<CalendarCreateMonthRvAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.cb.isEnabled = isActiveDate && adapter.days[holder.adapterPosition].isEnabled && isActiveDate && adapter.days[holder.adapterPosition].isSelected
        holder.cb.setOnCheckedChangeListener { buttonView, isChecked ->
            if(isChecked){
                adapter.days[holder.adapterPosition].isWorkingDay = 1
            }else {
