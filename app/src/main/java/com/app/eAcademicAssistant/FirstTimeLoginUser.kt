...
class FirstTimeLoginUser : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_first_time_login_user)
        etMail = findViewById(R.id.snMail)
        btnSubmit = findViewById(R.id.BtnSignUp)
        val txt1 = findViewById<TextView>(R.id.suSkip)
        ...
        val txt2 = findViewById<TextView>(R.id.snLogin)
                ...
                try {
                    ...
                    when (response.code()) {
                        OkHttpUtils.STATUS_OK -> {
                            runOnUiThread {
                                Toast.makeText(this@FirstTimeLoginUser, "Password send to $email ", Toast.LENGTH_SHORT).show()
                                val intent=Intent(this@FirstTimeLoginUser,LoginActivity::class.java)
                        ...
                        OkHttpUtils.STATUS_ERROR -> {
                            ...
                            runOnUiThread {
//                                Toast.makeText(this@FirstTimeLoginUser, "An error occured ..!!", Toast.LENGTH_SHORT).show()
                                btnSubmit.text = "Get Password"
                                btnSubmit.isEnabled = true
                                SnackBarUtils.showSnackBar(this@FirstTimeLoginUser, message)
